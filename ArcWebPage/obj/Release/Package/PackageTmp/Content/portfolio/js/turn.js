    ...
    var has3d,
        ...
        turnMethods = {
            ...
            init: function(options) {
                ...
                $(this).bind(mouseEvents.down, data.eventHandlers.touchStart).bind("end", turnMethods._eventEnd)
                    .bind("pressed", turnMethods._eventPressed).bind("released", turnMethods._eventReleased)
            ...
            _movePages: function(from, change) {
                ...
                var page,
                    ...
                    move = function(page) {
                        ...
                        if (data.pageObjs[page])
                            data.pageObjs[next] = data.pageObjs[page].removeClass("p" + page + " odd even")
                        ...
                        if (data.pagePlace[page] && data.pageWrap[page]) {
                            ...
                            if (data.pageObjs[next].hasClass("fixed"))
                                ...
                                data.pageWrap[next] = data.pageWrap[page]
                                    .css(turnMethods._pageSize.call(that, next, true)).attr("page", next);
                ...
                if (display === undefined) {
                    ...
                    case "single":
                        ...
                        if (!data.pageObjs[0]) {
                            ...
                            data.pageObjs[0] = $("<div />",
                                    { 'class': "page p-temporal" }).css({ width: this.width(), height: this.height() })
                                .appendTo(this);
                        }
            ...
            update: function() {
                ...
                if (this.turn("animating") && data.pageMv[0] !== 0) {
                    ...
                    for (page in data.pageWrap) {
                        ...
                        if ((p = data.pages[page])) {
                            ...
                            if (data.tpage) { // Is it turning the page to `tpage`?
                                ...
                                p.flip("hover", corner === false).flip("disable",
                    ...
                    for (page in data.pageWrap) {
                        ...
                        if (data.pages[page]) {
                            data.pages[page].flip("disable", data.disabled || pageLocation != 1).flip("hover", true)
                                .flip("z", null);
                        }
                    }
                }
...
// Methods and properties for the flip page effect
        ...
        flipMethods = {
            ...
            _backGradient: function() {
                ...
                var data = this.data().f,
                    turnData = data.opts.turn.data(),
                    gradient = turnData.opts.gradients &&
                    (turnData.display == "single" ||
                        (data.opts.page != 2 && data.opts.page != turnData.totalPages - 1));

                if (gradient && !data.bshadow)
                    data.bshadow = $("<div/>", divAtt(0, 0, 1))
                        .css({ 'position': "", width: this.width(), height: this.height() }).appendTo(data.parent);
            ...
            resize: function(full) {
                ...
                case "sheet":
                    ...
                    if (full) {
                        ...
                        data.fwrapper.css({ width: size, height: size }).children(":first-child")
            ...
            _addPageWrapper: function() {
                ...
                if (!data.wrapper)
                    ...
                    case "sheet":
                        ...
                        data.fwrapper = $("<div/>", divAtt(parent.offset().top, parent.offset().left)).hide()
                            .appendTo(data.fparent);

                        data.fpage = $("<div/>", divAtt(0, 0, 0, "visible")).css({ cursor: "default" })
            ...
            _fold: function(point) {
                ...
                case "hard":
                    ...
                    data.wrapper.transform("rotateY(" +
                        angle +
                        "deg)" +
                        "translate3d(0px, 0px, " +
                        (this.attr("depth") || 0) +
                    ...
                    if (turnData.opts.gradients) {
                        ...
                        gradient(data.bshadow,
                            ...
                            [[0, "rgba(0,0,0,0.3)"], [1, "rgba(0,0,0,0)"]],
                            2);
                    ...
                    var that = this,
                        ...
                        compute = function() {
                            ...
                            if (turnData.opts.gradients) {
                                ...
                                var endingPoint = flipMethods._c2.call(that, point.corner),
                                    far = Math.sqrt(Math.pow(endingPoint.x - point.x, 2) +
                        ...
                        transform = function(tr, c, x, a) {
                            ...
                            data.fpage.css(cssA).transform(
                                rotate(a) +
                                translate(tr.x + df.x - mv.x - width * x[0] / 100,
                                    tr.y + df.y - mv.y - height * x[1] / 100,
                                    ac) +
                                rotate((180 / a - 2) * a),
                                origin);

                            data.wrapper.transform(translate(-tr.x + mvW - aliasingFk, -tr.y + mvH, ac) + rotate(-a),
                                origin);

                            data.fwrapper.transform(translate(-tr.x + mv.x + mvW, -tr.y + mv.y + mvH, ac) + rotate(-a),
                                origin);
