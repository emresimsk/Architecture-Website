...
function initDomik() {
    ...
    $(".fullwidth-slider-holder a.next-slide").on("click",
        function() {
            $(this).closest(".fullwidth-slider-holder").find(b).trigger("owl.next");
        });
    $(".fullwidth-slider-holder  a.prev-slide").on("click",
        function() {
    ...
    $(".fullscreen-slider-holder a.next-slide").on("click",
        function() {
            $(this).closest(".fullscreen-slider-holder").find(c).trigger("owl.next");
        });
    $(".fullscreen-slider-holder a.prev-slide").on("click",
        function() {
    ...
    $(".hor a.arrow-left").on("click",
        function(a) {
            a.preventDefault();
            f.swipePrev();
        });
    $(".hor a.arrow-right").on("click",
        function(a) {
            a.preventDefault();
            f.swipeNext();
        });
    ...
    $(".fullheight-carousel-holder a.next-slide").on("click",
        function() {
            $(this).closest(".fullheight-carousel-holder").find(g).trigger("owl.next");
        });
    $(".fullheight-carousel-holder a.prev-slide").on("click",
        function() {
    ...
    $(".single-slider-holder a.next-slide").on("click",
        function() {
            $(this).closest(".portfolio-slider-holder").find(h).trigger("owl.next");
        });
    $(".single-slider-holder a.prev-slide").on("click",
        function() {
    ...
    $(".slide-title a , .box-item a.ajax , .carousel-link-holder").on("click",
        function() {
            $("nav a").removeClass("act-link");
            $(".pp").addClass("act-link");
        });
    $(".single-title a").on("click",
        function() {
            $("nav a").removeClass("act-link");
    ...
    $(".filter-button").on("click",
        function() {
            if ($(".gallery-filters").hasClass("vis-filter")) o();
            else p();
            return false;
        });
