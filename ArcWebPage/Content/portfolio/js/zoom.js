    ...
    var has3d,
        ...
        zoomMethods = {
            init: function(opts) {
                ...
                if ($.isTouch) {
                    ...
                    options.flipbook.bind("touchstart", data.zoom.eventTouchStart)
                        .bind("touchmove", data.zoom.eventTouchMove).bind("touchend", data.zoom.eventTouchEnd);
            ...
            zoomIn: function(event) {
                ...
                if (transitionEnd)
                    data.zoomer.bind(transitionEnd,
                        function() {
                ...
                if (!unlimited) {
                    ...
                    var out,
                        ...
                        maxBound = point2D(
                            ...
                            (flip.height() > this.height())
                            ? flip.height() - this.height()
                            : (flip.height() - this.height()) / 2
                        );
            ...
            _eTurned: function(event, page) {
                ...
                if (this.zoom("value") != 1) {
                    ...
                    if (page > data.page)
                        this.zoom("scroll",
                            point2D(0, data.scrollPos.y),
                            false,
                            true);
                    else if (page < data.page)
                        this.zoom("scroll",
                            point2D(flip.width(), data.scrollPos.y),
                            false,
                            true);
            ...
            _eDestroying: function() {
                ...
                flip.unbind("touchstart", data.eventTouchStart).unbind("touchmove", data.eventTouchMove)
