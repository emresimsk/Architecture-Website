...
(function(factory) {
    ...
    function spectrum(element, o) {
        ...
        function initialize() {
            ...
            clearButton.bind("click.spectrum",
                function(e) {
                    e.stopPropagation();
                    e.preventDefault();
                    isEmpty = true;
            ...
            toggleButton.text(opts.showPaletteOnly ? opts.togglePaletteMoreText : opts.togglePaletteLessText);
            toggleButton.bind("click.spectrum",
                function(e) {
                    e.stopPropagation();
                    e.preventDefault();
            ...
            initialColorContainer.delegate(".sp-thumb-el:nth-child(1)",
                paletteEvent,
                { ignore: true },
                paletteElementClick);
        }
        ...
        function drawPalette() {
            ...
            if (selectionPalette) {
                html.push(paletteTemplate(getUniqueSelectionPalette(),
                    currentColor,
        ...
        function drawInitial() {
            if (opts.showInitial) {
                ...
                var current = get();
                initialColorContainer.html(paletteTemplate([initial, current],
                    current,
    ...
    */
    ...
    $.fn.spectrum.inputTypeColorSupport = function inputTypeColorSupport() {
        if (typeof inputTypeColorSupport._cachedResult === "undefined") {
            var colorInput =
                $("<input type='color'/>")[0]; // if color element is supported, value will default to not null
    ...
    (function() {
        ...
        tinycolor.prototype = {
            ...
            toString: function(format) {
                ...
                var needsAlphaFormat = !formatSet &&
                    hasAlpha &&
